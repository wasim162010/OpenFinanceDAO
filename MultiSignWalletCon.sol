...
contract MultiSignWalletCon is Storage {
    ...
    */
    ...
    function checkNoOfUsers() public view returns(uint){ //test
        return numOfUsers;
    }
   ...
   function totalSupply() public view returns (uint256) {
    ...
    function checkvalInWEI() public view returns(uint){//test
        return valInWEI;
    }
    
    function checkConfirmCount(uint txId) public view returns(uint){//test
        return transactions[txId].confirmCount;
    }
    
    function checkPercent() public view returns(uint){ //test
        
        return numOfUsers * 51 / 100 ;
    }
